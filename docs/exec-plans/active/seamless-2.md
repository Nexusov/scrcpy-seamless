...
| P1.3 | Add initial DocsCheck | Deterministic local Markdown link/anchor and required-path checks, focused fixtures, and the applicable local/CI invocation | Pending |
