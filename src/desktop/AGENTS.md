...
Win32, Process, concrete filesystem and IPC. Phase 5A may replace the Desktop
placeholder with reusable product Views/ViewModels and explicit, side-effect-free
preview composition. Real configuration, ADB and native-host integration belong
to approved later Phase 5 slices; Phase 6 machine IPC remains separate. Read the
